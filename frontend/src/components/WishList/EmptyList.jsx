            ...
            <OuterContainer>
                <CartContainer>
                    <Typography variant="h4" sx={{ fontWeight: 'bold', width: '824.19px' }}>
                        My <span style={{ color: '#7E57C2' }}>List</span>
                    </Typography>

                    <Box mt={4} display="flex" flexDirection="column" alignItems="center">
                        <img src={squiggle} alt="squiggle" width={160} height={160} />
                    </Box>

                    <Typography variant="body2" mt={3} textAlign="center">
                        Looks like your WishList is feeling a little lonely— fill it up with something it’ll love!
                    </Typography>
