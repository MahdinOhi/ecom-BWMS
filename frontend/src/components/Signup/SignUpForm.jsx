...
const SignUpForm = () => (
     ...
     <div className="p-4 sm:p-6 lg:p-8 w-full max-w-md mx-auto lg:mx-0 flex flex-col justify-start lg:justify-center min-h-full py-8 lg:py-4">
    <div className="w-full space-y-1">
      ...
      <div className="flex items-start text-xs sm:text-sm text-gray-600 my-3 sm:my-4">
        <input 
          ...
          id="terms-checkbox"
        />
        <label htmlFor="terms-checkbox" className="leading-relaxed text-xs mb-1">
          By clicking Create account, I agree that I have read and accepted the Terms of Use and Privacy Policy.
        </label>
      </div>
      
      <button className="w-full py-3 sm:py-4 bg-indigo-600 hover:bg-indigo-700 transition-colors text-white rounded-lg mb-3 sm:mb-4 font-medium">
        Sign up
      </button>
      
      <div className="text-sm sm:text-base text-center mb-3 sm:mb-4">
